            ...
            body: BlocBuilder<FetchHotelWithoutTierCubit,
              ...
              builder: (context, state) {
                ...
                if (state is FetchHotelWithoutTierSuccess) {
                  return HotelWithoutTierSuccessPage(
                    data: data,
...
class HotelWithoutTierSuccessPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocListener<ResumbitAccommodationVerificationCubit,
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            Container(
              ...
              child: Stack(
                children: [
                  ...
                  if (fetchHostelWithoutTierSuccess.accommodation.is_pending !=
                      true)
                    Positioned(
                        right: 20,
                        top: 20,
                            ...
                            if (files.isNotEmpty) {
                              ...
                              if (croppedFile != null) {
                                ...
                                if (loginState is LoginLoaded) {
                                  await context
                                      .read<UpdateHotelWithoutTierCubit>()
                            ...
                            InkWell(
                              onTap: () async {
                                await editAccommodaiton(
                                    accommodation: fetchHostelWithoutTierSuccess
                                        .accommodation,
                                    context: context);
                      ...
                      Column(
                        children: [
                          ListView.builder(
                            ...
                            itemCount:
                                fetchHostelWithoutTierSuccess.room.length,
            ...
            if (fetchHostelWithoutTierSuccess.accommodation.is_rejected!)
              Padding(
                padding:
